...
Java.perform(() => {
    ...
    const FilteredPresenter = Java.use("com.swiftsoft.anixartd.presentation.main.filtered.FilteredPresenter$onFiltered$3");

    hook = function (
        handler: (self: any, args: any[], orig: (...args: any[]) => any) => any
    ) {
        const ov = FilteredPresenter.invoke.overloads.find((o: any) =>
