...
Java.perform(() => {
    ...
    const CollectionPresenter = Java.use("com.swiftsoft.anixartd.presentation.main.collection.CollectionPresenter$onCollection$3");

    hook = function (
        handler: (self: any, args: any[], orig: (...args: any[]) => any) => any
    ) {
        const ov = CollectionPresenter.invoke.overloads.find((o: any) =>
