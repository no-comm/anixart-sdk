...
Java.perform(() => {
    ...
    const ReportPresenter = Java.use("com.swiftsoft.anixartd.presentation.main.report.ReportPresenter$onReportSend$3");

    hook = function (
        handler: (self: any, args: any[], orig: (...args: any[]) => any) => any
    ) {
        const ov = ReportPresenter.invoke.overloads.find((o: any) =>
