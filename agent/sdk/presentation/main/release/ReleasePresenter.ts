...
Java.perform(() => {
    ...
    const ReleasePresenter = Java.use("com.swiftsoft.anixartd.presentation.main.release.ReleasePresenter$onRelease$3");

    hook = function (
        handler: (self: any, args: any[], orig: (...args: any[]) => any) => any
    ) {
        const ov = ReleasePresenter.invoke.overloads.find((o: any) =>
