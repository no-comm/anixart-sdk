...
Java.perform(() => {
    ...
    const ReleaseStreamingPlatformPresenter = Java.use("com.swiftsoft.anixartd.presentation.main.streaming.ReleaseStreamingPlatformPresenter$onStreamingPlatform$3");

    hook = function (
        handler: (self: any, args: any[], orig: (...args: any[]) => any) => any
    ) {
        const ov = ReleaseStreamingPlatformPresenter.invoke.overloads.find((o: any) =>
