...
Java.perform(() => {
    ...
    const BookmarksTabPresenter = Java.use("com.swiftsoft.anixartd.presentation.main.bookmarks.BookmarksTabPresenter$onFavorites$3");

    hook = function (
        handler: (self: any, args: any[], orig: (...args: any[]) => any) => any
    ) {
        const ov = BookmarksTabPresenter.invoke.overloads.find((o: any) =>
