...
Java.perform(() => {
    ...
    const UpdatePresenter = Java.use("com.swiftsoft.anixartd.presentation.main.update.UpdatePresenter$onUpdate$3");

    hook = function (
        handler: (self: any, args: any[], orig: (...args: any[]) => any) => any
    ) {
        const ov = UpdatePresenter.invoke.overloads.find((o: any) =>
